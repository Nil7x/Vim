...
export const actions: Action[] = [
    ...
    // new G key enhance
    parseKeysExact(["g", "r"], [Mode.Normal], async (vimState, editor) => {
        await vscode.commands.executeCommand("editor.action.referenceSearch.trigger");
    }),

    parseKeysExact(["g", "D"], [Mode.Normal], async (vimState, editor) => {
    ...
    parseKeysExact(["g", "p"], [Mode.Normal], async (vimState, editor) => {
        await vscode.commands.executeCommand("editor.action.peekTypeDefinition");
    }),

    parseKeysExact(["g", "h"], [Mode.Normal], async (vimState, editor) => {
        //vscode.commands.executeCommand("editor.action.showHover");
        await vscode.commands.executeCommand("editor.action.showDefinitionPreviewHover")
    }),

    parseKeysExact(["g", "U"], [Mode.Normal], async (vimState, editor) => {
